      ...
      <div className="w-[1039px] h-[732px] bg-white shadow-2xl rounded-3xl overflow-hidden flex">
        ...
        <div className="w-1/2 h-full p-16 flex flex-col justify-center relative">
            <div className="absolute top-8 right-12 flex gap-3">
                ...
                <Link to="/register-kandidat" className="px-6 py-2 text-sm font-semibold text-gray-600 bg-white border border-gray-200 rounded-lg hover:bg-gray-50">Sign Up</Link>
            </div>
            ...
            <div className="mt-8">
                ...
                <div className="bg-gray-100 p-1.5 rounded-xl flex mb-8">
                    ...
                    <Link to="/login-rekruter" className="flex-1 py-2.5 text-center rounded-lg text-sm font-medium text-gray-500 hover:text-gray-700 flex items-center justify-center gap-2 transition-all">
                ...
                <form className="space-y-5">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="email" className="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all" placeholder="name@example.com" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type={showPassword ? "text" : "password"} className="block w-full pl-10 pr-10 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all" placeholder="Enter your password" />
                    ...
                    <Link to="/dashboard" className="block w-full py-3.5 px-4 bg-[#155DFC] hover:bg-blue-700 text-white font-semibold rounded-xl text-center shadow-lg shadow-blue-500/30 transition-all transform hover:-translate-y-0.5">
                        Sign In as Candidate
                    </Link>
                </form>

                <p className="mt-8 text-center text-gray-500 text-sm">
                    Don't have an account? <Link to="/register-kandidat" className="text-blue-600 font-semibold hover:underline">Sign up</Link>
                </p>
            </div>
        </div>
      </div>
