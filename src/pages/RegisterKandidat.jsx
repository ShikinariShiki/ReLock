      ...
      <div className="w-[1039px] h-[873px] bg-white shadow-2xl rounded-3xl overflow-hidden flex">
        ...
        <div className="w-1/2 h-full bg-[#155DFC] text-white p-12 relative overflow-hidden flex flex-col">
            ...
            <div className="relative z-10">
                ...
                <h1 className="text-[36px] font-bold leading-tight mb-6">Join Relock Today!</h1>
        ...
        <div className="w-1/2 h-full p-16 relative flex flex-col justify-center">
            <div className="absolute top-8 right-12 flex gap-3">
                <Link to="/login-kandidat" className="px-6 py-2 text-sm font-semibold text-gray-600 bg-white border border-gray-200 rounded-lg hover:bg-gray-50">Login</Link>
            ...
            <div className="mt-8">
                ...
                <div className="bg-gray-100 p-1.5 rounded-xl flex mb-8">
                    ...
                    <Link to="/register-rekruter" className="flex-1 py-2.5 text-center rounded-lg text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-50 transition-all flex items-center justify-center gap-2">
                ...
                <form className="space-y-5">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="email" placeholder="you@example.com" className="block w-full pl-10 px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all" />
                        </div>
                    </div>
                    ...
                    <Link to="/dashboard" className="block w-full py-3.5 px-4 bg-[#155DFC] hover:bg-blue-700 text-white font-semibold rounded-xl text-center shadow-lg shadow-blue-500/30 transition-all transform hover:-translate-y-0.5 mt-6">
                        Create Candidate Account
                    </Link>
                </form>
                
                <p className="mt-8 text-center text-gray-500 text-sm">
                    Already have an account? <Link to="/login-kandidat" className="text-blue-600 font-semibold hover:underline">Sign in</Link>
                </p>
            </div>
        </div>
      </div>
