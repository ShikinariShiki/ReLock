...
export default function RegisterRecruiter() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-[#EFF6FF] via-white to-[#EFF6FF]">
      ...
      {/* Komponen Notifikasi Sukses (Overlay) */}
      {showSuccess && (
        <SuccessNotification 
      ...
      <div className="w-[1039px] h-[873px] bg-white shadow-2xl rounded-2xl overflow-hidden flex">
        ...
        <div className="w-1/2 h-full bg-gradient-to-br from-[#155DFC] to-[#1447E6] text-white p-12 relative overflow-hidden flex flex-col justify-center">
          {/* ... (Dekorasi & Logo sama seperti sebelumnya) ... */}
        ...
        <div className="w-1/2 h-full p-12 relative flex flex-col justify-center">
          ...
          <div className="absolute top-8 right-12 flex gap-2">
            <Link to="/login-recruiter" className="px-3 py-2 text-[14px] font-medium text-[#1A1A1A] bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition">
              Login
            </Link>
          ...
          <div className="max-w-md mx-auto w-full mt-10">
            ...
            <div className="bg-gray-100 p-1 rounded-full flex mt-8 h-[40px]">
              <Link to="/register-candidate" className="w-1/2 py-1 text-center rounded-full text-[14px] font-medium text-[#64748B] hover:text-[#1A1A1A] transition flex items-center justify-center gap-2">
            ...
            <div className="text-center mt-4 pb-4">
              <p className="text-[16px] font-normal text-[#4A5565]">
                Already have an account? <Link to="/login-register" className="font-medium text-[#155DFC] hover:underline">Sign in</Link>
              </p>
            </div>
          </div>
        </div>
