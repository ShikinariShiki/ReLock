        ...
        <div className="p-6 border-b border-gray-200 flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Melamar untuk: <span className="font-semibold">{jobTitle}</span>{" "}
              di <span className="font-semibold">{companyName}</span>
            </p>
          </div>
          <button
            onClick={onClose}
                ...
                >
                  <Upload
                    className={`mx-auto mb-2 ${
                      newFile ? "text-green-600" : "text-gray-400"
                    }`}
                    size={32}
                  />
                  <p
                    className={`text-sm font-medium ${
                      newFile ? "text-green-700" : "text-gray-700"
                    }`}
                  >
                    {newFile
                      ? newFile.name
